...
const courses = [
    { name: "Data Science", url: "/courses/datascience.html" },
    { name: "IT Certifications", url: "/courses/itcertification.html" },
    { name: "Leadership", url: "/courses/leadership.html" },
    { name: "Web Development", url: "/courses/webdevelopment.html" },
    { name: "Communication", url: "/courses/communication.html" }
];
